        ...
        {/* <section className="main_header_logo_section">
          <div className="main_header_layout inner">
            <div className="main_header_logo_wrap">
              ...
              <nav className="main_header_gnb_menu">
                <ul className="main_header_gnb_menu_list">
                  <li className="main_header_gnb_menu_list_li">
                    <Link to="#" className="main_header_gnb_menu_list_a">
                      커뮤니티
                    </Link>
                  </li>
                  <li className="main_header_gnb_menu_list_li">
              ...
              <div className="main_header_input_wrap">
                <input type="text" className="input_box" />
              </div>
              <div className="main_header_my_page_wrap">
                <img src="./images/common/my_page_img.png" alt="장바구니이미지" className="main_header_my_page_img" />
              </div>
              <nav className="main_header_sns_wrap">
                <ul className="main_header_sns_list">
                  <li className="main_header_sns_list_li">
                    <Link to="#" className="main_header_sns_list_a">
                      로그인
                    </Link>
                  </li>
                  <li className="main_header_sns_list_li">
              ...
              <div className="main_header_write_box">
                <span className="main_header_write_span">글쓰기 > </span>
              </div>
            </div>
          </div>
        </section> */}
          ...
          <div className="main_header_gnb_inner inner">
            <nav className="main_header_gnb_wrap">
              <ul className="main_header_gnb_list">
                <li className="main_header_gnb_list_li">
                  <Link to="#" className="main_header_gnb_list_a">
                    홈
                  </Link>
                </li>
                <li className="main_header_gnb_list_li">
            ...
            <nav className="main_header_gnb_shop_wrap">
              <ul className="main_header_gnb_shop_list">
                <li className="main_header_gnb_shop_list_li">
                  <Link to="#" className="main_header_gnb_shop_list_link">
                    허먼밀러
                  </Link>
                </li>
                <li className="main_header_gnb_shop_list_li">
