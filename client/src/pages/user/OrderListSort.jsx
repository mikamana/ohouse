...
export default function OrderListSort() {
                    ...
                    <div className="house_cate_list_modal">
                        <ul className='house_cate_list_modal_list'>
                            <li className='house_cate_list_modal_list_li'>
                                <button className={modalBtn === 0 ? 'house_cate_list_modal_list_li_btn active' : 'house_cate_list_modal_list_li_btn'} 
                                onClick={setModal} data-id="asc">
                                    최신순
                                </button>
                            </li>
                            <li className='house_cate_list_modal_list_li'>
                                <button className={modalBtn === 1 ? 'house_cate_list_modal_list_li_btn active' : 'house_cate_list_modal_list_li_btn'} 
